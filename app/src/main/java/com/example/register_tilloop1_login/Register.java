 ...
 *  address, password and their Date of birth. The details are bundled and passed onto
 *  the Main activity after Registration is complete.
 *
...
public class Register extends AppCompatActivity{
    ...
    public void register_user(View view){
        ...
        if(!IfEmptyOrInvalid(registerLayout)) {
            ...
            //Create a bundle of data to be passed
